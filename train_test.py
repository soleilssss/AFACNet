...
if __name__ == '__main__':
    ...
    train_dataset = BowelDataset(root = 'training data root',transform = transform_train)    # 这是训练集
    print('训练集长度:', len(train_dataset))
    train_dataloaders = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=2)
    val_dataset = BowelDataset(root = 'val data root',transform = transform_val)       # 这是验证集
